...
class Activity(models.Model):
    ...
    source = models.ForeignKey(Object, related_name="activities_with_source", null=True, blank=True)
    actor_bundle = models.ForeignKey(ObjectBundle, related_name="activities_with_actor", null=True, blank=True)
    object_bundle = models.ForeignKey(ObjectBundle, related_name="activities_with_object", null=True, blank=True)
    target_bundle = models.ForeignKey(ObjectBundle, related_name="activities_with_target", null=True, blank=True)
    source_bundle = models.ForeignKey(ObjectBundle, related_name="activities_with_source", null=True, blank=True)
    source_account = models.ForeignKey(Account, related_name="activities", null=True, blank=True)
    source_person = models.ForeignKey(Person, related_name="activities", null=True, blank=True)
